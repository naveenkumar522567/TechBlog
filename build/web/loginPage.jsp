                ...
                <div class ="col-md-6 offset-md-3">
                    ...
                    <div class ="card" style="-webkit-box-shadow: 0px 0px 52px 1px rgba(0,0,0,0.91);
                        ...
                        <div class ="card-header bg-white text-center mt-3">
                            <span class="fa fa-user-circle fa-5x text-primary"></span>
                            <br>
                            <h4>Login Here</h4>
                        </div>
                        ...
                        <div class ="card-body ">
                            ...
                            <form action = "LoginServlet" method ="POST">
                                ...
                                <div class = "container text-center">
                                    <button type="submit" class=" col-sm-8 btn btn-primary mt-2">Log In</button>
                                </div>

                            </form
                            <div class = "container text-center ">
                                <div class="sign-up mt-2" style="text-align:center;">
                                    Don't have an account? <a href="registerPage.jsp">Create One</a>
                                </div>
                            </div>
